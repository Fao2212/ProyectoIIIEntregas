...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Arista a3 = new Arista(v3,v4,true,12,12,1);
        Arista a4 = new Arista(v4,v5,true,7,7,6);
        Arista a5 = new Arista(v5,v1,true,4,4,4);
        Arista a6 = new Arista(v1,v6,true,9,9,5);
        Arista a7 = new Arista(v2,v6,true,10,10,3);
